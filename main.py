...
from forms import CreatePostForm, RegisterForm, LoginForm, CommentField
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if not check_password_hash(user.password, password_):
...
def show_post(post_id):
    ...
    return render_template("post.html", post=requested_post, current_user=current_user, users=users, form=form)
